...
function CheckArmorType()
  ...
  function NeckArmorHit()
    Neckhits = Neckhits + 1
    --print("hit Neck")
    if Neckhits == 5 and NeckArmor ~= nil then
  ...
  function ArmorArmRight1Hit()
    ...
    --print("hit Rarmup")
    if ArmorArmRight1Hits == 5 and ArmorArmRight1 ~= nil then
  ...
  function ArmorArmRight2Hit()
    ...
    --print("hit Rarmlow")
    if ArmorArmRight2Hits == 5 and ArmorArmRight2 ~= nil then
  ...
  function ArmorArmLeft1Hit()
    ...
    --print("hit Larmup")
    if ArmorArmLeft1Hits == 5 and ArmorArmLeft1 ~= nil then
  ...
  function ArmorArmLeft2hit()
    ...
    --print("hit larmlow")
    if ArmorArmLeft2Hits == 5 and ArmorArmLeft2 ~= nil then
  ...
  function Thigh1SideArmorHit()
    ...
    --print("hit thighside")
    if Thigh1SideArmorHits == 5 and Thigh1SideArmor ~= nil then
  ...
  function Thigh2SideArmorHit()
    ...
    --print("hit thighside")
    if Thigh2SideArmorHits == 5 and Thigh2SideArmor ~= nil then
